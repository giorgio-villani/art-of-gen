    ...
    <div className="w-full flex flex-col items-center">
      ...
      <section className="max-w-[800px] w-full px-4 text-center">
        <p className="mb-6 text-left text-center text-justify">
          ...
          community. Join us for an inspiring event that showcases local talent, fosters creativity, and strengthens the cultural fabric of our neighborhood. Together with Fresh Arts, we are making a
