  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 m-2">
        {pieces.map((piece) => (
          <div key={piece.id} className="relative overflow-hidden bg-gray-300 flex items-center justify-center text-2xl text-center text-white group">
            <a href={`/pieces/${piece.id}`} className="relative w-full h-full">
              {/* Image */}
